...
const translations = {
  ru: {
    ...
    "about.intro1":
      "Вам не нужно никуда ходить, звонить или тратить время — просто со своего рабочего места закажите обед на удобное для вас время. Наши обеды готовит ресторан AZURE, и вы можете быть уверены в их свежести, качестве и происхождении продуктов — что особенно важно в современном ритме жизни.",
    "about.intro2":
      "Меню обновляется каждый день! Ланчи доступны по очень актуальным ценам: можно выбрать 2 или 3 блюда. А если заказываете на компанию — получите бонусы:",
    "about.li1": "при заказе 5 и более полных обедов — всем дарим фирменную выпечку",
    "about.li2":
      "при заказе на неделю вперёд — каждый обед комплектуется бесплатным напитком и десертом",
    "about.intro3":
      "Ken Dala Food Service — это обеды не только для офиса. Срок хранения наших блюд — 72 часа, поэтому вы \
    ...
    "about.rule.text":
      "Мы делаем всё, чтобы ваш обед был вкусным, свежим и максимально удобным. Выбирайте блюда, оформляйте заказ \
    ...
    "about.rule.text3":
      "Комбинируйте по вкусу: Салат / Суп / Горячее. Можно выбрать 2 или 3 блюда, напиток добавляется \
                  автоматический.",
    ...
    "about.rule.text5":
      "С 12:00 до 16:00. Выберите удобный интервал (30 минут) при оформлении заказа.",
    ...
    "about.rule.text7":
      "Все блюда готовятся утром и доставляются в день заказа. Срок годности — 72 часа с даты изготовления \
                  (указана на упаковке).",
    "about.rule.title8": "8. Можно заказывать и домой",
    "about.rule.text8":
      "Наши обеды подойдут не только для офиса, но и для ужина дома. Благодаря герметичной упаковке и сроку \
                  хранения 72 часа, вы можете заказывать несколько боксов вперёд и спокойно кормить всю семью — вкусно, \
                  свежо и удобно.",
    "about.intro4":
      "Мы всегда на связи — пишите или звоните, с радостью всё подскажем и поможем оформить заказ. «Ken Dala Food \
  ...
  kk: {
    ...
    "about.intro1":
      "Ешқайда барудың, қоңырау шалудың немесе уақытыңызды өткізудің қажеті жоқ — тек жұмыс орныңыздан өзіңізге ыңғайлы уақытта түскі асқа тапсырыс беріңіз. Біздің түскі астарды AZURE мейрамханасы дайындайды, сондықтан тағамдардың балғындығына, сапасына және өнімдердің шығу тегіне сенімді бола аласыз — бұл қазіргі қарқынды өмір ырғағында өте маңызды.",
    "about.intro2":
      "Мәзір күн сайын жаңарып отырады! Ланчтар қолжетімді бағамен ұсынылады: 2 немесе 3 тағамды таңдауға болады. Ал егер сіз компанияңызбен бірге тапсырыс берсеңіз — бонустар аласыз:",
    "about.li1":
      "5 және одан да көп толық түскі асқа тапсырыс бергенде — бәріне фирмалық тәтті тағам сыйлыққа",
    "about.li2":
      "Апта бойына алдын ала тапсырыс берсеңіз — әрбір түскі асқа тегін сусын мен десерт қосылады",
    "about.intro3":
      "Ken Dala Food Service — тек кеңсеге ғана емес, үйге де арналған түскі астар. Тағамдарымыздың сақтау мерзімі — 72 сағат, сондықтан сіз оларды кешкі асқа да тапсырыс бере аласыз. Өзіңізге ғана емес, жақындарыңызға да қамқор болыңыз — дәмді, тез және қауіпсіз.",
    "about.rule.title": "Тапсырыс беру ережелері",
    "about.rule.text":
      "Біз сіздің түскі асыңыз дәмді, балғын және барынша ыңғайлы болуы үшін барымызды саламыз. Тағамдарды таңдап, бірнеше рет басу арқылы тапсырыс беріңіз — және өз уақытыңызда дәмді асты алыңыз.",
    ...
    "about.rule.text2":
      "PRO ТҮСКІ АС — ыңғайлы орама, жаңартылған мәзір және күн сайын балғын тағамдар.",
    "about.rule.title3": "3. Түскі ас құрамы",
    "about.rule.text3":
      "Өзіңізге ұнайтындай таңдаңыз: Салат / Сорпа / Ыстық тағам. 2 немесе 3 тағамды таңдауға болады, сусын автоматты түрде қосылады.",
    ...
    "about.rule.text5":
      "12:00-ден 16:00-ге дейін. Тапсырыс беру кезінде ыңғайлы 30 минуттық аралықты таңдаңыз.",
    ...
    "about.rule.text7":
      "Барлық тағамдар таңертең дайындалып, сол күні жеткізіледі. Сақтау мерзімі — дайындау күнінен бастап 72 сағат (қаптамада көрсетілген).",
    "about.rule.title8": "8. Үйге де тапсырыс беруге болады",
    "about.rule.text8":
      "Біздің түскі астар тек кеңсе үшін емес, үйдегі кешкі асқа да тамаша сай келеді. Герметикалық орам мен 72 сағаттық сақтау мерзімі арқасында бірнеше боксты алдын ала тапсырыс беріп, бүкіл отбасыңызды дәмді және балғын тағаммен қамтамасыз ете аласыз.",
    "about.intro4":
      "Біз әрдайым байланыстамыз — жазыңыз немесе қоңырау шалыңыз, қуана көмектесеміз және кеңес береміз. «Ken Dala Food Service» — қайта-қайта тапсырыс бергіңіз келетін түскі астар.",
